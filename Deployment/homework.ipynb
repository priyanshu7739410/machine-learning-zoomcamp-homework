 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "fd9c4e4e-fcf8-4787-ac73-0f4283281867",
   "metadata": {},
   "outputs": [],
   "source": [
    "import pandas as pd\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "904c0c13-e23c-4fc9-897e-956e61893bf4",
   "metadata": {},
   "outputs": [
    {
     "name": "stderr",
     "output_type": "stream",
     "text": [
      "/home/codespace/.local/lib/python3.12/site-packages/sklearn/base.py:380: InconsistentVersionWarning: Trying to unpickle estimator DictVectorizer from version 1.5.2 when using version 1.6.0. This might lead to breaking code or invalid results. Use at your own risk. For more info please refer to:\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "ac2efeb3-4297-4859-b77f-107383d8c76c",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 10,
   "id": "7ca163b8-908a-44e3-a654-5f651a70e509",
   "metadata": {},
   "outputs": [],
   "source": [
    "data7 = {\n",
    ...
    "}\n",
    "\n",
    "customer1 = pd.DataFrame(data7)"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 12,
   "id": "51b53c04-b1f0-460a-95dd-fbeac0178658",
   "metadata": {},
   "outputs": [],
   "source": [
    "# Assuming 'customer1' is your DataFrame\n",
    "customer_dicts = customer1.to_dict(orient='records')\n",
    "\n",
    "# Now you can apply the transformation\n",
    "cust = dv.transform(customer_dicts)\n"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 16,
   "id": "b0bb9386-3455-49e1-a8f5-ed75cfd8f2e5",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "id": "d93f7475-ca74-4ef5-bcc8-91a598e9bd71",
   "metadata": {},
   "outputs": [],
   "source": []
  }
